...
function M.ensure_review_highlights()
  ...
  define_hl("I18nStatusReviewText", "String")
  define_hl("I18nStatusReviewDiffAdd", "Added", "DiagnosticOk")
  define_hl("I18nStatusReviewPath", "Directory")
  define_hl("I18nStatusReviewValue", "String")
